...
var AsyncStateRef = /** @class */ (function (_super) {
    ...
    function AsyncStateRef(promise, onStatusChanged) {
        var _this = _super.call(this, { provided: promise }, { status: Status.Pending, promise: promise }, onStatusChanged) || this;
        _this.promise = promise.then(function (result) {
            _this.setState({ status: Status.Resolved, result: result });
            return result;
        }, function (thrown) {
            var error = isPromise(thrown)
                ? new Error('Promise thrown inside of promise')
                : thrown;
            _this.setState({ status: Status.Rejected, error: error });
            throw error;
        });
        return _this;
    }
...
var SyncStateRef = /** @class */ (function (_super) {
    ...
    function SyncStateRef(result, onStatusChanged) {
        return _super.call(this, { provided: result }, { status: Status.Resolved, result: result }, onStatusChanged) || this;
    }
    return SyncStateRef;
}(AbstractStateRef));
var FailedStateRef = /** @class */ (function (_super) {
    ...
    function FailedStateRef(error) {
        return _super.call(this, null, { status: Status.Rejected, error: error }) || this;
    }
...
var TAbstractObservable = /** @class */ (function (_super) {
    ...
    TAbstractObservable.prototype.__removeObserver = function (observer) {
        ...
        if (this.observers.size === 0 &&
            ...
            ((_a = this.stateRef) === null || _a === void 0 ? void 0 : _a.getStatus()) !== Status.Pending) {
    ...
    TAbstractObservable.prototype.__checkForNoObservers = function () {
        ...
        ref != null &&
            ...
            this.releaseTimeoutID = getConfig().setTimeout(function () { return _this.release(ref); }, releaseDelay === ReleaseDelay.Default
    ...
    AbstractSelectorMap.prototype.getSelector = function (key) {
        ...
        if (selector == null) {
            ...
            function (observer) { return _this.getState(observer, key); }, __assign$1(__assign$1({ 
                ...
                releaseDelay: ReleaseDelay.Default }, this.options), { onRelease: function (value) {
                    var _a, _b, _c;
...
export { AsyncObservable, AsyncObservableMap, AsyncObserver, AsyncSelector, AsyncSelectorMap, ComponentObserver, Observable, ObservableAnimation, ObservableMap, ObservableStore, ReleaseDelay, Selector, SelectorMap, Status, SyncObserver, setConfigOptions };
