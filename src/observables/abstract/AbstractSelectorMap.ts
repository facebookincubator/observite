 ...
 */
export type getKeyStateCB<TKey, TProvide> = (
 ...
 */
export type SelectorMapOptions<TKey, TProvide> = Omit<
...
> {
  ...
  private getState: getKeyStateCB<TKey, TProvide>;
  private options: Maybe<SelectorMapOptions<TKey, TProvide>>;
