  ...
  constructor(options?: Maybe<ObservableOptions<TProvide>>) {
    ...
    if (options != null) {
      ...
      if (defaultValue !== undefined) {
        this.stateRef = stateRefFromProvided<TResolve, TProvide>(defaultValue);
      }
    }
  }
